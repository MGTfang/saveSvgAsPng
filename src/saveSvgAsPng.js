...
(function () {
    ...
    var inlineImages = function inlineImages(el, toURL) {
    ...
    out$.prepareSvg = function (el, options, done) {
        ...
        var top = _ref3$top === undefined ? 0 : _ref3$top
        ...
        var scale = _ref3$scale === undefined ? 1 : _ref3$scale

        var _ref3$responsive = _ref3.responsive

        var responsive = _ref3$responsive === undefined ? false : _ref3$responsive

        return inlineImages(el, !_ref3.canvg).then(function () {
    ...
    out$.svgAsPngUri = function (el, options, done) {
        ...
        var _ref5$encoderType = _ref5.encoderType

        var encoderType = _ref5$encoderType === undefined ? 'image/png' : _ref5$encoderType

        var _ref5$encoderOptions = _ref5.encoderOptions

        var encoderOptions = _ref5$encoderOptions === undefined ? 0.8 : _ref5$encoderOptions

        var canvg = _ref5.canvg
        ...
        var convertToPng = function convertToPng(_ref6) {
            ...
            try {
                if (canvg) {
                    ...
                    context.fillStyle = _ref5.backgroundColor || '#fff'
